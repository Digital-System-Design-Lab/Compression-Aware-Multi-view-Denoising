...
,   const float sigma
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 500);
    ...
    for (unsigned k = 0; k < size; k++)
    {
        ...
        os << "a : " << a << " b : " << b << endl;
        //cout << "getpid() : " << getpid() << " time : " << time << endl;
...
void add_noise2(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 0);
...
void add_noise3(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 23000);
...
void add_noise4(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 11000);
...
void add_noise5(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 110);
...
void add_noise6(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 15000);
...
void add_noise7(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 51000);
...
void add_noise8(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 71000);
...
void add_noise9(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 31000);
...
void add_noise10(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 91000);
...
void add_noise11(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 81000);
...
void add_noise12(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 3000);
...
void add_noise13(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 900);
...
void add_noise14(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 99000);
...
void add_noise15(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 110000);
...
void add_noise16(
    ...
    mt_init_genrand((unsigned long int) time (NULL) + (unsigned long int) 1100000);
...
,   const bool rgb2yuv
    ...
    else if (color_space == OPP)
    {
        ...
        #pragma omp parallel for
            ...
            {
                //! Red   channel
                tmp[3*k + 0] = 1.0f * img[k + red] + 1.0f * img[k + green] + 0.666f * img[k + blue];
                //! Green cha
